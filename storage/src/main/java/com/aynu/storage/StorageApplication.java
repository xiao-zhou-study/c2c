...
@MapperScan("com.aynu.storage.mapper")
public class StorageApplication {
    ...
    private static void printLog(Environment env) {
        try {
            ...
            String appName = env.getProperty("spring.application.name", "Storage-Service");
            ...
            log.warn("Storage Service log metadata resolution failed.");
        }
    }
}