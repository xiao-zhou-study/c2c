...
@MapperScan("com.aynu.item.mapper")
public class ItemApplication {
    ...
    private static void printLog(Environment env) {
        try {
            ...
            String appName = env.getProperty("spring.application.name", "Item-Service");
            ...
            log.warn("Item Service log metadata resolution failed.");
        }
    }
}