...
@MapperScan("com.aynu.review.mapper")
public class ReviewApplication {
    ...
    private static void printLog(Environment env) {
        try {
            ...
            String appName = env.getProperty("spring.application.name", "Review-Service");
            ...
            log.warn("Review Service log metadata resolution failed.");
        }
    }
}