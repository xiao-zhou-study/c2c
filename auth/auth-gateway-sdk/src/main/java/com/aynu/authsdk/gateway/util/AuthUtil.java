package com.aynu.authsdk.gateway.util;
...
import com.aynu.common.exceptions.ForbiddenException;
import com.aynu.common.exceptions.UnauthorizedException;
...
import static com.aynu.auth.common.constants.AuthErrorInfo.Code.EXPIRED_TOKEN_CODE;
import static com.aynu.auth.common.constants.AuthErrorInfo.Code.INVALID_TOKEN_CODE;
import static com.aynu.auth.common.constants.AuthErrorInfo.Msg.*;
import static com.aynu.auth.common.constants.JwtConstants.*;
...
public class AuthUtil {
    ...
    private List<PrivilegeRoleDTO> loadPrivileges() {
        ...
        return values.stream().map(json -> JSONUtil.toBean(json, PrivilegeRoleDTO.class)).collect(Collectors.toList());
    }
