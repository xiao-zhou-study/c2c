...
import com.aynu.auth.domain.po.RolePrivilege;
import com.aynu.auth.mapper.PrivilegeMapper;
import com.aynu.auth.service.IPrivilegeService;
...
import static com.aynu.auth.constants.AuthConstants.ADMIN_ROLE_ID;
...
public class PrivilegeServiceImpl extends ServiceImpl<PrivilegeMapper, Privilege> implements IPrivilegeService {
    ...
    public void bindRolePrivileges(Long roleId, List<Long> privilegeIds) {
        ...
        // 2.判断权限是否存在
        int privilegeCount = Math.toIntExact(lambdaQuery().in(Privilege::getId, privilegeIds).count());
