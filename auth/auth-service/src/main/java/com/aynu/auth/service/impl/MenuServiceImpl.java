...
import com.aynu.auth.constants.AuthConstants;
import com.aynu.auth.domain.po.AccountRole;
import com.aynu.auth.domain.po.Menu;
import com.aynu.auth.domain.po.RoleMenu;
import com.aynu.auth.mapper.MenuMapper;
import com.aynu.auth.service.IAccountRoleService;
import com.aynu.auth.service.IMenuService;
import com.aynu.auth.service.IRoleMenuService;
import com.aynu.auth.service.IRoleService;
import com.aynu.common.exceptions.CommonException;
...
import static com.aynu.auth.common.constants.AuthErrorInfo.Msg.MENU_NOT_FOUND;
import static com.aynu.auth.common.constants.AuthErrorInfo.Msg.ROLE_NOT_FOUND;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    public void deleteMenu(Long id) {
        ...
        if (menu.getHasChildren()) {
            // 2.1.添加子菜单及父菜单
            delIds = lambdaQuery().eq(Menu::getParentId, id)
                    .list()
                    .stream()
                    .map(Menu::getId)
