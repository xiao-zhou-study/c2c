...
import com.aynu.common.utils.AssertUtils;
...
import com.aynu.user.mapper.UserMapper;
...
import static com.aynu.user.constants.UserConstants.*;
import static com.aynu.user.constants.UserErrorInfo.Msg.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void addUserByPhone(User user, String code) {
        ...
        // 2.判断手机号是否存在
        int count = Math.toIntExact(lambdaQuery().eq(User::getCellPhone, user.getCellPhone()).count());
        if (count > 0) {
