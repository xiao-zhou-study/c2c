package com.aynu.common.autoconfigure.mq;
...
import static com.aynu.common.constants.Constant.REQUEST_ID_HEADER;
import static com.aynu.common.constants.MqConstants.Exchange.ERROR_EXCHANGE;
import static com.aynu.common.constants.MqConstants.Key.ERROR_KEY_PREFIX;
import static com.aynu.common.constants.MqConstants.Queue.ERROR_QUEUE_TEMPLATE;
...
public class MqConfig implements EnvironmentAware {
    ...
    @ConditionalOnProperty(prefix = "spring.rabbitmq.listener",
            name = "type",
            havingValue = "simple",
            matchIfMissing = true)
