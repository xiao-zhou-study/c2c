...
import com.aynu.common.utils.TjTemporalConverter;
...
@Configuration
@ConditionalOnProperty(prefix = "xy.swagger", name = "enable",havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(prefix = "xy.swagger", name = "enableResponseWrap",havingValue = "true")
